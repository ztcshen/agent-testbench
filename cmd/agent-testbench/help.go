...
Usage:
  ...
  agent-testbench task schedule NAME --command COMMAND --interval DURATION [--store NAME_OR_DSN] [--shell] [--json]
  agent-testbench task worker [--store NAME_OR_DSN] [--once] [--poll-interval DURATION] [--json]
...
Usage:
  ...
  agent-testbench task schedule NAME --command COMMAND --interval DURATION [--store NAME_OR_DSN] [--shell] [--notify-file PATH] [--notify-webhook URL] [--json]
  agent-testbench task worker [--store NAME_OR_DSN] [--once] [--poll-interval DURATION] [--json]
  ...
  agent-testbench task stop NAME [--store NAME_OR_DSN] [--recover-running-claim --confirm-side-effects-reviewed] [--json]
  agent-testbench notify test (--file PATH | --webhook URL) [--message TEXT] [--json]
  ...
  agent-testbench environment restore ENV_ID --workspace PATH [--store NAME_OR_DSN] [--execute] [--pull] [--prepare-repos-only] [--assume-clean-docker] [--use-existing-containers] [--clean-docker-state] [--clean-docker-images] [--allow-destructive-docker-cleanup] [--run-workflow --server-url URL] [--health-timeout-seconds N] [--output-format text|json|stream-json] [--json]
  agent-testbench environment status ENV_ID --workspace PATH [--store NAME_OR_DSN] [--health-timeout-seconds N] [--json]
  ...
  agent-testbench environment acceptance start ENV_ID --server-url URL --request-id ID [--timeout-seconds N] [--json]
  ...
  agent-testbench evidence inspect --view list [--store NAME_OR_DSN] [--run ID] [--json]
  agent-testbench evidence inspect --view tasks --run ID [--store NAME_OR_DSN] [--step ID] [--case ID] [--kind KIND] [--status STATUS] [--json]
  ...
  agent-testbench map import-workflows [--store NAME_OR_DSN] [--map ID] [--workflow ID] [--append] [--display-name NAME] [--description TEXT] [--json]
  ...
  agent-testbench map validation promote --map ID (--case CASE_ID | --node NODE_ID) [--interface ID] [--store NAME_OR_DSN] [--json]
  ...
  agent-testbench map run [--map ID | --plan PLAN_ID] [--scope all|workflows|cases] [--case CASE_ID | --node NODE_ID | --path PATH_ID | --workflow WORKFLOW_ID] [--resume | --retry-failed | --skip-passed | --rerun-task TASK_ID] [--concurrency N] [--environment ENV_ID] [--base-url URL] [--evidence-dir PATH] [--timeout-seconds N] [--store NAME_OR_DSN] [--json]
...
Serve reads template package catalog data from the local Store. When --profile is set,
the external package is first published into the Store/read-model, then served
