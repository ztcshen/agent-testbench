...
Usage:
  ...
  agent-testbench workflow discover --profile PATH_OR_ID --offline-template-package [--profile-home PATH] [--filter TEXT] [--service ID] [--json]
  ...
  agent-testbench map run [--map ID | --plan PLAN_ID] [--scope all|workflows|cases] [--case CASE_ID | --node NODE_ID | --path PATH_ID | --workflow WORKFLOW_ID] [--environment ENV_ID] [--base-url URL] [--evidence-dir PATH] [--timeout-seconds N] [--store NAME_OR_DSN] [--json]
  agent-testbench map run explain --plan PLAN_ID [--store NAME_OR_DSN] [--json]
  agent-testbench map review-html --map ID [--store NAME_OR_DSN] [--filter TEXT] [--output PATH] [--json]
