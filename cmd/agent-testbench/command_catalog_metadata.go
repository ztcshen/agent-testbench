...
const (
	...
	commandCatalogCaseCatalogUpsert            = "case catalog upsert"
	commandCatalogCaseCatalogHistory           = "case catalog history"
	commandCatalogCaseCatalogRollback          = "case catalog rollback"
	commandCatalogCaseConfigUpsert             = "case config upsert"
