...
Usage:
  ...
  agent-testbench research scope --scope PATH [--scope PATH...] [--scope-file PATH] [--changed-since REF] [--include-untracked] --radar-index PATH [--query TEXT] [--min-references N] [--limit N] [--reference-limit N] [--live-check] [--max-star-drift N] [--max-pushed-drift-hours N] [--github-api-url URL] [--json]
