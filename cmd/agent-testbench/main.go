...
Usage:
  ...
  agent-testbench research command --command TEXT --radar-index PATH [--min-references N] [--limit N] [--reference-limit N] [--live-check] [--max-star-drift N] [--max-pushed-drift-hours N] [--github-api-url URL] [--json]
  agent-testbench research scope --scope PATH [--scope PATH...] [--scope-file PATH] [--write-scope-file PATH] [--changed-since REF] [--include-untracked] --radar-index PATH [--query TEXT] [--min-references N] [--limit N] [--reference-limit N] [--live-check] [--max-star-drift N] [--max-pushed-drift-hours N] [--github-api-url URL] [--json]
  agent-testbench research sync --radar-root PATH [--radar-index PATH] [--refresh-limit N] [--max-age-hours N] [--min-references N] [--seed-only] [--strict-search] [--live-check] [--live-limit N] [--reference-limit N] [--max-star-drift N] [--max-pushed-drift-hours N] [--github-api-url URL] [--execute] [--json]
  ...
  agent-testbench research gate --feature TEXT --radar-index PATH [--require-min-matches N] [--require-command COMMAND] [--scope PATH] [--scope-file PATH] [--write-scope-file PATH] [--changed-since REF] [--include-untracked] [--max-age-hours N] [--live-check] [--max-star-drift N] [--max-pushed-drift-hours N] [--json]
