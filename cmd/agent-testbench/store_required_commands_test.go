...
func dailyPlanningStoreRequiredCases(missingProfile string) []storeRequiredCommandCase {
	return []storeRequiredCommandCase{
		...
		{name: "case suite stability", args: []string{"case", "suite", "report", "--view", "stability", "--profile", missingProfile, "--json"}},
		{name: "case suite coverage", args: []string{"case", "suite", "report", "--view", "coverage", "--profile", missingProfile, "--json"}},
		{name: "case suite priority", args: []string{"case", "suite", "report", "--view", "priority", "--profile", missingProfile, "--json"}},
		{name: "case suite brief", args: []string{"case", "suite", "report", "--view", "brief", "--profile", missingProfile, "--json"}},
		{name: "case suite quality", args: []string{"case", "suite", "report", "--view", "quality", "--profile", missingProfile, "--json"}},
		{name: "case suite quality-plan", args: []string{"case", "suite", "report", "--view", "quality-plan", "--profile", missingProfile, "--json"}},
		{name: "case suite quality-report", args: []string{"case", "suite", "report", "--view", "quality-report", "--profile", missingProfile, "--json"}},
		{name: "case suite inspect", args: []string{"case", "suite", "report", "--view", "inspect", "--profile", missingProfile, "--json"}},
		{name: "case suite plan", args: []string{"case", "suite", "report", "--view", "plan", "--profile", missingProfile, "--json"}},
		{name: "case suite impact", args: []string{"case", "suite", "report", "--view", "impact", "--profile", missingProfile, "--json"}},
		{name: "case suite impact-report", args: []string{"case", "suite", "report", "--view", "impact-report", "--profile", missingProfile, "--json"}},
	}
}
