...
func parseEnvironmentRestoreCommandOptions(args []string) (environmentRestoreCommandOptions, error) {
	...
	baseURL := flags.String("base-url", "", "Deprecated: configure verification targets in the Store catalog")
	workflowOutputDir := flags.String("workflow-output-dir", "", "Deprecated: configure verification Evidence paths in the Store catalog")
