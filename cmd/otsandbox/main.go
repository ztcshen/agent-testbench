...
Usage:
  ...
  otsandbox profile audit --profile PATH_OR_ID --offline-template-package [--profile-home PATH] [--store NAME_OR_DSN] [--store-url PATH] [--json] [--force]
  otsandbox profile audit-plan --profile PATH_OR_ID --offline-template-package [--profile-home PATH] [--store NAME_OR_DSN] [--store-url PATH] [--json] [--force]
  ...
  otsandbox workflow audit --workflow ID [--store NAME_OR_DSN] [--store-url PATH] [--json]
  otsandbox workflow audit --profile PATH --offline-template-package --workflow ID [--store NAME_OR_DSN] [--store-url PATH] [--json]
