...
create table if not exists test_plan_maps (
  ...
  updated_at %s not null
		...
		d.CreateIndexSQL("idx_test_plan_maps_profile", "test_plan_maps", []string{"profile_id", "status", "updated_at", "map_id"}),
	}
}
...
create table if not exists test_plan_nodes (
  ...
  foreign key (map_id) references test_plan_maps(map_id) on delete cascade
		...
		d.CreateIndexSQL("idx_test_plan_nodes_case", "test_plan_nodes", []string{"map_id", "case_id", "node_id"}),
		d.CreateIndexSQL("idx_test_plan_nodes_interface", "test_plan_nodes", []string{"map_id", "interface_node_id", "role"}),
	}
}
...
create table if not exists test_plan_edges (
  ...
  foreign key (map_id) references test_plan_maps(map_id) on delete cascade
		...
		d.CreateIndexSQL("idx_test_plan_edges_to", "test_plan_edges", []string{"map_id", "to_node_id", "kind"}),
		d.CreateIndexSQL("idx_test_plan_edges_from", "test_plan_edges", []string{"map_id", "from_node_id", "kind"}),
	}
}
...
create table if not exists test_plan_paths (
  ...
  foreign key (map_id) references test_plan_maps(map_id) on delete cascade
		...
		d.CreateIndexSQL("idx_test_plan_paths_workflow", "test_plan_paths", []string{"map_id", "workflow_id", "path_id"}),
		fmt.Sprintf(`
create table if not exists test_plan_path_steps (
  ...
  foreign key (map_id) references test_plan_maps(map_id) on delete cascade
		...
		d.CreateIndexSQL("idx_test_plan_path_steps_node", "test_plan_path_steps", []string{"map_id", "node_id", "path_id", "step_index"}),
	}
}
