...
runtime indexes, run records, imported import bundle indexes, and baseline gate state;
external import bundle bundles and Evidence files remain file-first source artifacts.
...
Store interface rather than changing external import bundle bundle files.
