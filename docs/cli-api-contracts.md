...
PostgreSQL-backed one-click restore requires service source repositories to be
...
remain compatibility inputs and are not the PostgreSQL daily restore source.
