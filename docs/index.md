...
- [Backend Capabilities](backend-capabilities.md): complete overview of Store,
  profile publishing, discovery, execution, reports, Evidence, Control plane
  APIs, and release guardrails. 完整了解 Store、配置发布、目标发现、执行、报告、证据、控制平面 API 和发布守卫。

## Profile Authors / 配置包作者

- [Profile Format](profile-format.md): manifest fields, split assets, audit,
  install, pack, import, and verify. 配置清单字段、拆分资产、审计、安装、打包、导入和验证。
- [Profile Authoring Guide](profile-authoring.md): practical workflow for
