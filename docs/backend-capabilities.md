...
| Reports / 报告 | `case suite report`, `case suite report --view impact-report`, `case suite report --view quality-report`, `interface-node case report`, `workflow plan`, `workflow report`, `/api/workflow-plan` |
