...
| Coverage / 覆盖 | `case suite coverage`, `case suite inspect`, `case suite plan`, `case suite impact`, `case incomplete-batches`, `/api/case/suite-coverage`, `/api/case/suite-inspection`, `/api/case/suite-plan`, `/api/case/suite-impact`, `/api/case/suite-impact-runs`, `/api/interface-node/coverage` |
